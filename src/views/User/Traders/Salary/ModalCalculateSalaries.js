...
const ModalCalculateSalaries = ({ isShow, closeModal, date = moment() }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "bonus",
      render: (data) => {
        return <Widgets.MoneyInput defaultValue={data.bonus} value={data.bonus} onChange={(e) => handleChange(data.id, e, 'bonus')} />
      },
    },
    {
      ...
      key: "bonus",
      render: (data) => {
        return <Widgets.MoneyInput defaultValue={data.punish} value={data.punish} onChange={(e) => handleChange(data.id, e, 'punish')} />
      },
    },
    {
      ...
      dataIndex: "salary",
      key: "salary",
      render: (salary) => <Widgets.NumberFormat needSuffix={false} value={salary} />,
    },
  ];
  return (
    <Modal
